...
// This catches a missing category in the JSON (too-few silently zero-fills in C).
...
const tropic_prodtest_config_distribution_t tropic_prodtest_config_distribution = {
    .reversible_version = 1,
    .irreversible_version = 0,
};
